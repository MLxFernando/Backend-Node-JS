...
const createBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield new BookController().create({ title, dateOfPublication, autor, languageNative, category });
...
const updateBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { title, dateOfPublication, autor, languageNative, category } = req.body;
    const docId = req.params.id;
    const response = yield new BookController().update(docId, { title, dateOfPublication, autor, languageNative, category });
    return res.status(response.status).json(response);
});
...
class BookController {
    create(books) {
        return __awaiter(this, void 0, void 0, function* () {
            const book = new book_model_1.Book(books);
